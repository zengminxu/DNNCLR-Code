...
class LE_Processor(Processor):
    ...
    def train(self, epoch):
        ...
        for data, label in loader:
            ...
            output1 = output.cpu().detach().numpy()  # here
            label1 = label.cpu().detach().numpy()  # here
            data1.append(output1)  # here
            data2.append(label1)  # here
        ...
        data11 = np.array(data1)  # here
        data21 = np.array(data2)  # here
        data12 = data11.reshape(-1, 60)  # here
        data22 = data21.reshape(-1)  # here
        np.save('/home/zhangxuelian/code_wuyushan/wu_aimclr_2.3.0/work_dir/tsne-draw/val_joint60_all_aimclr_joint_xsub.npy', data12)  # here
        np.save('/home/zhangxuelian/code_wuyushan/wu_aimclr_2.3.0/work_dir/tsne-draw/val_joint60_all_label_aimclr_joint_xsub.npy', data22)  # here
        print()  # here
