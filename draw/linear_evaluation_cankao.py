...
class LE_Processor(Processor):
    ...
    def train(self, epoch):
        ...
        data21 = np.array(data2)
        data12 = data11.reshape(-1, 60)
        data22 = data21.reshape(-1)
        np.save('/home/zxl/下载/ntu60/xview10-best1/val_position60.npy', data12)
        np.save('/home/zxl/下载/ntu60/xview10-best1/val_label60.npy', data22)
        print()
